...
class WXRImporter extends \WP_Importer {
	 ...
	 *     @var bool $generate_attachments_metadata Generate attachments metadata includind all image sizes. (True generates, false skips generation. Default is true.)
	 *     @var bool $generate_image_sizes Image sizes to generate for each attachment. (Default is ['thumbnail', 'medium'])
	...
	public function __construct( $options = array() ) {
		...
		$this->options = wp_parse_args( $options, array(
			...
			'generate_attachments_metadata' => true,
